...
/**
 * Entry point of the 'UsageGeneration' generation module.
 *
 * @generated
 */
public class UsageGeneration extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/acceleo/module/palladio/usage/UsageGeneration";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "UsageGeneration" };
     ...
     * @generated
     */
    public UsageGeneration(URI modelURI, File targetFolder,
     ...
     */
    public UsageGeneration(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                UsageGeneration generator = new UsageGeneration(modelURI, folder, arguments);
