 ...
 * @generated
 */
public class BasicComponent extends AbstractAcceleoGenerator {
    /**
     ...
     * @generated
     */
    public BasicComponent(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public BasicComponent(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                BasicComponent generator = new BasicComponent(modelURI, folder, arguments);
