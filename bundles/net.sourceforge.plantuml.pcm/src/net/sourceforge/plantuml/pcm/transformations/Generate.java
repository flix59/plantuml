 ...
 *******************************************************************************/
package net.sourceforge.plantuml.pcm.transformations;
 ...
 * @generated
 */
public class Generate extends AbstractAcceleoGenerator implements IAcceleoTextGenerationListener {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/net/sourceforge/plantuml/pcm/transformations/generate";
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                generator.addGenerationListener(generator);
    ...
    public void doGenerate(Monitor monitor) throws IOException {
        ...
        Map<String, String> result = super.generate(monitor);
        return;
    }
